...
When you double click on the Resize.exe file you'll get a warning message, click on the 'More info' option (Figure 4)
...
First click on the program file (Resize.exe in the table above) which will take you to a new page, on the upper right hand corner click on the icon of a tray with an arrow pointing to it (Figure 6). This will then start the download which will ultimately get you to the first warning (Figure 2).
